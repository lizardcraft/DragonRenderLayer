...
public class WingsGeoModel extends GeoModel<DragonFeaturesAnimatable> {
	@Override
	public ResourceLocation getAnimationResource(DragonFeaturesAnimatable object) {
		return new ResourceLocation(CelestialdragonMod.MODID, "animations/wings.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(DragonFeaturesAnimatable object) {
		return new ResourceLocation(CelestialdragonMod.MODID, "geo/wings.geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(DragonFeaturesAnimatable object) {
		return new ResourceLocation(CelestialdragonMod.MODID, "textures/item/wings_texture.png");
	}
}
